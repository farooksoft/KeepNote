...
describe('AuthenticationService', () => {
  ...
  it('should handle to set and get auth token in local storage', fakeAsync(() => {
  ...
  it('should handle 404 error for isAuthenticated function', fakeAsync(() => {
    requestURL = testConfig.isAuthURL;
  ...
  it('should handle 403 error for isAuthenticated function', fakeAsync(() => {
    requestURL = testConfig.isAuthURL;
